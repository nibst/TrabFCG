...
#define DEFAULT_P1 glm::vec4(5.0,0.1,5.0,1.0)
#define DEFAULT_P2 glm::vec4(50.0,0.1,20.0,1.0)
#define DEFAULT_P3 glm::vec4(10.0,0.1,30.0,1.0)
#define DEFAULT_P4 glm::vec4(60.0,0.1,40.0,1.0)
