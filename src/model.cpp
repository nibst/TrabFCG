...
size_t Model::getFirstIndex(){return this->first_index;}
size_t Model::getNumIndices(){return this->num_indices;}
GLenum Model::getRenderingMode(){return this->rendering_mode;}
VAO Model::getVAO(){return this->vao;}
glm::vec3 Model::getBboxMin(){return this->bbox_min;}
glm::vec3 Model::getBboxMax(){return this->bbox_max;}

Model::Model(){;}
Model::Model(std::string name,size_t first_index,size_t num_indices,
...
void Model::setObjectID(GLint id){
    this->id = id;
}
GLint Model::getID(){
    return this->id;
...
void Model::computeNormals(ObjModel* model)
{
...
void Model::buildTriangles(ObjModel* model)
{
...
void Model::loadFromOBJFileName(const char* filename){
