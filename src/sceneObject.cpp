...
std::string SceneObject::getName(){return this->name;}
...
GLint SceneObject::getID(){
    return this->id;
}
// Função que computa as normais de um ObjModel, caso elas não tenham sido
// especificadas dentro do arquivo ".obj"
void SceneObject::computeNormals(ObjModel* model)
{
...
void SceneObject::loadFromOBJFileName(const char* filename){
